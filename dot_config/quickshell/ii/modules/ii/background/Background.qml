...
Variants {
    ...
    PanelWindow {
        ...
        Item {
            ...
            // Iris-in transition: snapshot of OLD wallpaper with a growing circular hole
            Item {
                id: irisOverlay
                anchors.fill: parent
                visible: irisAnim.running

                property string oldWallpaperPath: bgRoot.wallpaperPath
                ...
                NumberAnimation on reveal {
                    ...
                    running: false
                    onFinished: irisOverlay.oldWallpaperPath = bgRoot.wallpaperPath
                }

                StyledImage {
                    id: oldWallpaperSnapshot
                    anchors.fill: parent
                    source: irisOverlay.oldWallpaperPath
                    fillMode: Image.PreserveAspectCrop
                    cache: false
                    smooth: true
                    layer.enabled: true
                ...
                Item {
                    ...
                    Rectangle {
                        ...
                        property real maxDim: Math.hypot(parent.width, parent.height) * 1.1
                        width: maxDim * irisOverlay.reveal
                        height: width
                        radius: width / 2
                        color: "white"
                    }
